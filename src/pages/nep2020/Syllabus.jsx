...
const syllabusData = [
  // Professional Courses - at top as requested
  {
    subject: 'BBA',
    files: [
      { name: 'BBA CBCS Syllabus', url: '/data files/CBCS Syllabus/BBA-cbcs-syllabus-.pdf' }
    ]
  },
  {
    subject: 'BCA',
    files: [
      { name: 'BCA Syllabus', url: '/data files/CBCS Syllabus/Syllabus-BCA.pdf' }
    ]
  },
  {
    subject: 'BSW',
    files: [
      { name: 'BSW', url: '/data files/CBCS Syllabus/BSW.pdf' }
    ]
  },
  // Commerce
  {
    subject: 'Commerce',
    files: [
      { name: 'Commerce', url: '/data files/CBCS Syllabus/Commerce.pdf' }
    ]
  },
  // Science Subjects
  {
    subject: 'Botany',
    files: [
      { name: 'Botany', url: '/data files/CBCS Syllabus/Botany.pdf' }
    ]
  },
  {
    subject: 'Chemistry',
    files: [
      { name: 'Chemistry', url: '/data files/CBCS Syllabus/chemistry.pdf' }
    ]
  },
  {
    subject: 'Physics',
    files: [
      { name: 'Physics', url: '/data files/CBCS Syllabus/Physics.pdf' }
    ]
  },
  {
    subject: 'Zoology',
    files: [
      { name: 'Zoology', url: '/data files/CBCS Syllabus/Zoology.pdf' }
    ]
  },
  // Arts & Humanities Subjects
  {
    subject: 'Arabic',
    files: [
      { name: 'Arabic', url: '/data files/CBCS Syllabus/arabic.pdf' }
    ]
  },
  {
    subject: 'Economics',
    files: [
      { name: 'Economics', url: '/data files/CBCS Syllabus/Economics.pdf' }
    ]
  },
  {
    subject: 'English',
    files: [
      { name: 'English', url: '/data files/CBCS Syllabus/english.pdf' }
    ]
  },
  {
    subject: 'Geography',
    files: [
      { name: 'Geography', url: '/data files/CBCS Syllabus/Geography.pdf' }
    ]
  },
  {
    subject: 'Hindi',
    files: [
      { name: 'Hindi', url: '/data files/CBCS Syllabus/Hindi.pdf' }
    ]
  },
  {
    subject: 'History',
    files: [
      { name: 'History', url: '/data files/CBCS Syllabus/History.pdf' }
    ]
  },
  {
    subject: 'Home Science',
    files: [
      { name: 'Home Science', url: '/data files/CBCS Syllabus/home science.pdf' }
    ]
  },
  {
    subject: 'Maithili',
    files: [
      { name: 'Maithili', url: '/data files/CBCS Syllabus/Maithili.pdf' }
    ]
  },
  {
    subject: 'Music',
    files: [
      { name: 'Music', url: '/data files/CBCS Syllabus/music.pdf' }
    ]
  },
  {
    subject: 'Persian',
    files: [
      { name: 'Persian', url: '/data files/CBCS Syllabus/Persian.pdf' }
    ]
  },
  {
    subject: 'Philosophy',
    files: [
      { name: 'Philosophy', url: '/data files/CBCS Syllabus/philosophy.pdf' }
    ]
  },
  {
    subject: 'Political Science',
    files: [
      { name: 'Political Science', url: '/data files/CBCS Syllabus/political science.pdf' }
    ]
  },
  {
    subject: 'Psychology',
    files: [
      { name: 'Psychology', url: '/data files/CBCS Syllabus/Psychology.pdf' }
    ]
  },
  {
    subject: 'Sanskrit',
    files: [
      { name: 'Sanskrit', url: '/data files/CBCS Syllabus/sanskrit.pdf' }
    ]
  },
  {
    subject: 'Sociology',
    files: [
      { name: 'Sociology', url: '/data files/CBCS Syllabus/Sociology.pdf' }
    ]
  },
  {
    subject: 'Statistics',
