...
const About = () => {
  ...
  const aboutSections = [
    { path: '/about/brief-profile', title: 'Brief Profile', description: 'Learn about the history and overview of Magadh Mahila College', icon: Building },
    { path: '/about/principal', title: 'Principal Profile', description: 'Meet our esteemed Principal and leadership team', icon: Users },
    { path: '/about/previous-principals', title: 'Previous Principals', description: 'Honorable former principals of the college', icon: Award },
    { path: '/about/emblem', title: 'College Emblem', description: 'The symbolic representation of our institution', icon: Star },
    { path: '/about/roll-of-honor', title: "Students' Roll of Honor", description: 'Celebrating our outstanding students', icon: GraduationCap },
    { path: '/about/code-of-ethics', title: 'Code of Ethics', description: 'Our commitment to ethical standards', icon: Shield },
    { path: '/about/code-of-conduct', title: 'Code of Conduct', description: 'Guidelines for student behavior and conduct', icon: CheckCircle },
    { path: '/about/melc', title: 'MELC', description: 'Modern Education and Learning Center', icon: BookOpen },
    { path: '/about/institutions-pride', title: 'Institutions\' Pride', description: 'Our achievements and recognitions', icon: TrendingUp },
    { path: '/about/vision-mission', title: 'Vision & Mission', description: 'Our goals and objectives', icon: Target },
    { path: '/about/best-practices', title: 'Best Practices', description: 'Excellence in education and administration', icon: Heart },
    { path: '/about/feedback-forms', title: 'Feedback Forms', description: 'Share your thoughts and suggestions', icon: Info },
    { path: '/about/environment-policy', title: 'Environmental Policy', description: 'Our commitment to sustainability', icon: HomeIcon },
    { path: '/about/mou', title: 'MOU', description: 'Memorandums of Understanding', icon: FileText },
    { path: '/about/future-plans', title: 'Future Plans', description: 'Our roadmap for the future', icon: Sparkles },
    { path: '/about/milestones', title: 'Milestones', description: 'Key achievements and landmarks', icon: Calendar },
    { path: '/about/visitors-note', title: "Visitor's Note", description: 'Messages from our esteemed visitors', icon: Users },
    { path: '/about/management-administration', title: 'Management & Administration', description: 'Governance and administrative structure', icon: Building },
  ];
