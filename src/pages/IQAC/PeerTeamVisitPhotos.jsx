...
const PeerTeamVisitPhotos = () => {
  ...
  const photos = [
    { src: '/data files/IQAC/NAAC/mmc_naac2013.jpg', alt: 'NAAC Peer Team Visit 2013' },
    { src: '/data files/IQAC/NAAC/mmc_naac2020.jpg', alt: 'NAAC Peer Team Visit 2020' },
    { src: '/data files/IQAC/NAAC/WhatsApp-Image-2021-02-11-at-3.04.42-PM.jpeg', alt: 'NAAC Peer Team Visit Photo' },
  ];
  ...
  const naacItems = [
    {
      ...
      link: '/data files/IQAC/NAAC/naac-visit-schedule.pdf'
    },
    {
    ...
    },
    {
      ...
      icon: FileText,
      color: 'from-primary to-highlight',
      link: '/data files/IQAC/NAAC/NAAC-PEER-TEAM-EXIT-MEETING.pdf'
    },
    {
      ...
      icon: Presentation,
      color: 'from-primary to-highlight',
      link: '/data files/IQAC/NAAC/principal-naac-9-march.pdf'
    },
    {
    ...
    },
    {
      ...
      icon: Building,
      color: 'from-primary to-highlight',
      link: '/data files/IQAC/NAAC/MAGADH-MAHILA-COLLEGE-SUMMARY.pdf'
    }
  ];
