...
The unit also organizes SSB training, and some cadets have joined defense services as officers. It emphasizes character building, leadership, camaraderie, patriotism, and holistic development.`,
    ...
    reportLinks: [
      { label: 'NCC Annual Report', href: '/documents/IQAC/NCC/mmc-ncc-report.pdf' },
      { label: 'NCC Report 2023-24', href: '/documents/IQAC/NCC/NCC-Report-2023-24.pdf' }
    ]
  },
  {
    id: 'nss',
...
NSS conducts regular and special camp activities and works with partners such as Red Cross and NGOs for blood donation and AIDS awareness programmes.`,
    ...
    reportLinks: [
      { label: 'NSS Annual Report 2022-23', href: '/documents/IQAC/NSS/mmc_nss_aanual_report_2223.pdf' },
      { label: 'NSS Report', href: '/documents/IQAC/NSS/mmc-nss-report-1.pdf' },
      { label: 'NSS Report 2023-24', href: '/documents/IQAC/NSS/NSS-Report-2023-24.pdf' }
    ]
  }
];
