                          ...
                          {folderImages.map((image, index) => (
                            ...
                            >
                              ...
                              <motion.img
                                ...
                                alt={image.name}
                                loading="lazy"
                                src={`/images/campus/${image.path.replace(/\s+/g, '-')}/${encodeURIComponent(image.name)}`}
          ...
          >
            ...
            >
              ...
              <img
                ...
                src={`/images/campus/${selectedImage.path.replace(/\s+/g, '-')}/${encodeURIComponent(selectedImage.name)}`}
                onError={(e) => {
                  e.target.src = 'https://images.unsplash.com/photo-1595872018818-97555653a011';
                }}
              />
